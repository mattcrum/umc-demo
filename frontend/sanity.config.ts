...
// Environment variables for project configuration - use Next.js public env vars since this runs in the browser
const projectId = process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || 'pyqdmhmt'
const dataset = process.env.NEXT_PUBLIC_SANITY_DATASET || 'umcorg'

// URL for preview functionality - since studio is on same domain, use relative or current origin
const SANITY_STUDIO_PREVIEW_URL = typeof window !== 'undefined' ? window.location.origin : 'https://umc-demo.vercel.app'
