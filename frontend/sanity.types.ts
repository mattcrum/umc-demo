...
// Query: *[_type == "settings"][0]{  _id,  _type,  title,  description,  ogImage,  heroTitle,  heroDescription,  heroImage,  heroVideo,  announcement,  serviceInfo{    times,    location->{      _id,      name,      address,      phone    }  },  contactInfo,  socialLinks}
