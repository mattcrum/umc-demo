...
// URL for preview functionality, defaults to deployed app or localhost for development
const SANITY_STUDIO_PREVIEW_URL = process.env.SANITY_STUDIO_PREVIEW_URL || 'https://umc-demo-steel.vercel.app'
